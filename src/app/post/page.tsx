...
export default function Page() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-4">
      <Link className="text-xl mb-4" href={"/"}>
        To Home Page
      </Link>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mt-10 mb-6">
              <label
                ...
                className="block text-sm font-bold text-black text-left"
              >
                落し物:
              </label>
              <input
            ...
            <div className="mb-6">
              <label
                htmlFor="file"
                className="block text-sm font-bold text-black mb-2 text-left"
              >
                画像ファイルをアップロード:
              </label>
              <input
            ...
            <div className="flex align-items: center justify-center">
              <button
                type="submit"
                disabled={loading}
                className={`p-2 w-1/2 mt-12 bg-black text-white rounded-md mx-auto ${
